...
#include "platform/platform_backend_auth.h"
...
Copies a string into a fixed-size destination buffer.
=============
*/
...
/*
=============
QL_InitAuthCredential

Initializes an auth credential container to a safe default.
=============
*/
...
/*
=============
QL_ParseLegacyKeyInternal

Parses a legacy CD-key string into the auth credential buffer.
=============
*/
...
Validates and normalizes legacy CD-key strings.
=============
*/
...
/*
=============
QL_ParseCredentialString

Parses a credential string with optional platform prefixes.
=============
*/
...
/*
=============
QL_ParsePlatformToken

Stores a platform token with the specified credential kind.
=============
*/
...
/*
=============
QL_GetCredentialLabel

Maps credential kinds to stable labels.
=============
*/
...
/*
=============
QL_FormatCredentialForStorage

Formats a credential for persistence in config files.
=============
*/
...
#if !defined(QL_AUTH_HAS_CLIENT_BACKEND)
/*
=============
QL_Auth_ExecuteRequest

Dispatches auth checks for game-module builds without the client transport.
=============
*/
qboolean QL_Auth_ExecuteRequest( const ql_auth_credential_t *credential, ql_auth_response_t *response ) {
	...
	QL_Backend_SetAuthResponse( response, QL_AUTH_RESULT_ERROR,
...
/*
=============
QL_RequestExternalAuth

Submits a credential to the configured backend and caches the response.
=============
*/
...
/*
=============
QL_FormatCredentialForAuthorize

Formats a credential payload for auth requests.
=============
*/

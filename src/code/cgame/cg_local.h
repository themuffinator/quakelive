...
typedef struct {
	...
	float		kickScale;
	float		bobScale;
	vec4_t		teamUpperColor;
	vec4_t		teamLowerColor;
	vec4_t		teamHeadColor;
	vec4_t		enemyUpperColor;
	vec4_t		enemyLowerColor;

...
// Retail Quake Live native DLL import slab recovered from qagamex86.dll and the
// engine-side import table. Zero gaps stay deliberately unbound until the
// committed HLIL/Ghidra corpus closes them more cleanly.
typedef enum {

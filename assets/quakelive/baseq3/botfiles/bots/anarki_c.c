...
skill 1
{
	CHARACTERISTIC_NAME							"Anarki"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.5
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/anarki_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/anarki_t.c"
	CHARACTERISTIC_CHAT_NAME					"anarki"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/anarki_i.c"

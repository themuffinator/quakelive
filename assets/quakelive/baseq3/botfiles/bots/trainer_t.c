...
//
// Name:		Crash_c.c
// Function:      chat lines for Trainer
...
chat "crash"
{
	...
	{
		"Welcome to Quake Live, warrior.";
		"You have entered Quake Live, ", 1, ". Prepare to fight.";
		// 0 = bot name
		//1 = random player
		//4 = level's title
	} //end type
	...
	{
		"~Don't worry, ", 3, ". I just got lucky!";
		"Good Game! We can practice anytime you like.";
		"Good game ", 3, ". I can't wait to play again!";
		// 0 = bot name
	} //end type

	type "level_end_lose" //initiated when a level ends and the bot is last in the rankings
	{
		"Marty would be proud of you, good game!";
		"Marty would be proud of you...good game!";
		"Good Game! Now you are ready for Quake Live!";
		"Good luck, ", 2, ". Now you are ready for Quake Live!";
		// 0 = bot name
	} //end type
	...
	type "hit_nokill" //bot hits an opponent but does not kill it
	{
		...
		"I'm shooting like Shortytoo today.";
	...
	type "death_suicide" //initiated when bot blows self up with a weapon or craters
	{
		...
		"~Don't laugh, Toddh has done the same thing.";
		// 0 = enemy name
	} //end type

	type "death_gauntlet" //initiated when the bot is killed by a gauntlet attack
	{
		"Have you been hanging out with patd again?";
	...
	type "death_insult" //insult initiated when the bot died
	{
		...
		"Did TTimo set you up to this?";
		"Nice frag, Bargle better watch out.";
		"Great. Now Maleficus is going to be mad at me.";
		// 0 = enemy name
	} //end type
	...
	type "death_praise" //praise initiated when the bot died
	{
			...
			"Oh my! SyncError look OUT!";
			"Next time you see patd, give him the gauntlet for me.";
			"Comfort better keep an eye on his ~rear view mirror now.";
			"Nice shot, Method would approve.";
			"Sorry. I'm not much of a challenge.";
			"Mmmm Boy, Jerry better watch his back!";
		// 0 = enemy name
	} //end type

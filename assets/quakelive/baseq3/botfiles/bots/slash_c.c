...
skill 1
{
	CHARACTERISTIC_NAME							"Slash"
	CHARACTERISTIC_GENDER						"female"
	CHARACTERISTIC_ATTACK_SKILL					0.5
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/slash_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/slash_t.c"
	CHARACTERISTIC_CHAT_NAME					"slash"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/slash_i.c"

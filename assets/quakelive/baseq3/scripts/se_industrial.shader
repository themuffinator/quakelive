...
textures/se_industrial/thomas
{
	...
	{
		map textures/se_industrial/thomas.tga
		blendfunc filter
		rgbGen identity
	}
	{
		map textures/se_industrial/thomas.blend.tga
		blendfunc add
	}
}

textures/se_industrial/guy
{
	{
		map $lightmap
		rgbGen identity
	...
	{
		map textures/se_industrial/guy.tga
		blendfunc filter
		rgbGen identity
	}
	{
		map textures/se_industrial/guy.blend.tga
		blendfunc add
	}
}

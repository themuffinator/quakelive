...
textures/tp_gothic/tp_metaltrim_001a_nonsolid
{
	qer_editorimage textures/tp_gothic/tp_metaltrim_001a.tga
	surfaceparm	nonsolid
	{
		map $lightmap
		rgbGen identity
	...
	{
		map textures/tp_gothic/tp_metaltrim_001a.tga
		blendfunc filter
	}
}
...
textures/tp_gothic/tp_darkbrick_001_nonsolid
{
	qer_editorimage textures/tp_gothic/tp_darkbrick_001.tga
	surfaceparm	nonsolid
	{
		map $lightmap
		rgbGen identity
	...
	{
		map textures/tp_gothic/tp_darkbrick_001.tga
		blendfunc filter
	}
}
